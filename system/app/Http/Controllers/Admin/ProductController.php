...
class ProductController extends Controller
{
    ...
    {
        $shippers = Shipper::getDefinedShippers();
        $cats = Category::all();
        //$shippers = Shipper::where(['user_id' => 0, 'status' => 1])->get();
        $sign = Currency::where('is_default', '=', 1)->first();
        return view('admin.product.create.physical', compact('cats', 'shippers', 'sign'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //--- Redirect Section
        $msg = 'Ürün başarıyla eklendi.<a href="' . route('admin-prod-index') . '">Ürün Listesini Görüntüle.</a>';
        return response()->json($msg);
    ...
    public function importSubmit(Request $request)
    {
        ...
        //--- Redirect Section
        $msg = 'Toplu Ürün Dosyası Başarıyla İçe Aktarıldı.<a href="' . route('admin-prod-index') . '">Ürün Listesini Görüntüle</a>' . $log;
        return response()->json($msg);
    }
    ...
    public function edit($id)
    {
        ...
        elseif ($data->type == 'License')
            ...
            return view('admin.product.edit.physical', compact('cats', 'data', 'sign', 'shippers'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //--- Redirect Section
        $msg = 'Ürün Başarıyla Güncellendi.<a href="' . route('admin-prod-index') . '">Ürün Listesini Görüntüle</a>';
        return response()->json($msg);
        //--- Redirect Section Ends
    }
    ...
    public function featuresubmit(Request $request, $id)
    {
        ...
        //--- Redirect Section
        $msg = 'Öne çıkarılan başarıyla güncellendi';
        return response()->json($msg);
        //--- Redirect Section Ends
