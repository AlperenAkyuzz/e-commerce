...
class AdminLanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        file_put_contents(public_path().'/system/resources/lang/'.$data->file, $mydata);
        //--- Logic Section Ends
    ...
    public function edit($id)
    {
        ...
        $data_results = file_get_contents(public_path().'/system/resources/lang/'.$data->file);
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
        $data = AdminLanguage::findOrFail($id);
        if (file_exists(public_path().'/system/resources/lang/'.$data->file)) {
            unlink(public_path().'/system/resources/lang/'.$data->file);
        }
        $data->language = $input['language'];
        $name = Str::random(10);
        $data->name = $name;
