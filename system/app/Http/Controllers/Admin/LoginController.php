...
class LoginController extends Controller
{
    ...
    public function forgot(Request $request)
    {
      ...
      $file = fopen(public_path().'/system/storage/tokens/'.$token.'.data','w+');
    ...
    {
      if (file_exists(public_path().'/system/storage/tokens/'.$token.'.data')){
        $id = file_get_contents(public_path().'/system/storage/tokens/'.$token.'.data');
    ...
    public function changepass(Request $request)
    {
        ...
        unlink(public_path().'/system/storage/tokens/'.$token.'.data');
