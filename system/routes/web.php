...
// Verification Section Ends
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        Route::get('/general-settings/custom-js', 'Admin\GeneralSettingController@customjs')->name('admin-gs-custom-js');
        ...
        Route::get('/shippers/datatables', 'Admin\Cargo\ShipperController@datatables')->name('admin-shippers-datatables');
        Route::get('/shippers', 'Admin\Cargo\ShipperController@index')->name('admin-shippers-index');
        Route::get('/shippers/create', 'Admin\Cargo\ShipperController@create')->name('admin-shippers-create');
        Route::post('/shippers/create', 'Admin\Cargo\ShipperController@store')->name('admin-shippers-store');
        Route::get('/shippers/edit/{id}', 'Admin\Cargo\ShipperController@edit')->name('admin-shippers-edit');
        Route::post('/shippers/edit/{id}', 'Admin\Cargo\ShipperController@update')->name('admin-shippers-update');
        Route::get('/shippers/delete/{id}', 'Admin\Cargo\ShipperController@destroy')->name('admin-shippers-delete');

        Route::get('/shipping-rates/datatables', 'Admin\Cargo\ShippingRateController@datatables')->name('admin-shipping-rates-datatables');
        Route::get('/shipping-rates', 'Admin\Cargo\ShippingRateController@index')->name('admin-shipping-rates-index');
        Route::get('/shipping-rates/create', 'Admin\Cargo\ShippingRateController@create')->name('admin-shipping-rates-create');
        Route::post('/shipping-rates/create', 'Admin\Cargo\ShippingRateController@store')->name('admin-shipping-rates-store');
        Route::get('/shipping-rates/edit/{id}', 'Admin\Cargo\ShippingRateController@edit')->name('admin-shipping-rates-edit');
        Route::post('/shipping-rates/edit/{id}', 'Admin\Cargo\ShippingRateController@update')->name('admin-shipping-rates-update');
        Route::get('/shipping-rates/delete/{id}', 'Admin\Cargo\ShippingRateController@destroy')->name('admin-shipping-rates-delete');

        Route::get('/shipper-rates/datatables', 'Admin\Cargo\ShipperRateController@datatables')->name('admin-shipper-rates-datatables');
        Route::get('/shipper-rates', 'Admin\Cargo\ShipperRateController@index')->name('admin-shipper-rates-index');
        Route::get('/shipper-rates/create', 'Admin\Cargo\ShipperRateController@create')->name('admin-shipper-rates-create');
        Route::post('/shipper-rates/create', 'Admin\Cargo\ShipperRateController@store')->name('admin-shipper-rates-store');
        Route::get('/shipper-rates/edit/{id}', 'Admin\Cargo\ShipperRateController@edit')->name('admin-shipper-rates-edit');
        Route::post('/shipper-rates/edit/{id}', 'Admin\Cargo\ShipperRateController@update')->name('admin-shipper-rates-update');
        Route::get('/shipper-rates/delete/{id}', 'Admin\Cargo\ShipperRateController@destroy')->name('admin-shipper-rates-delete');
...
// ------------ GLOBAL ----------------------
    ...
    Route::post('/general-settings/update/customjs', 'Admin\GeneralSettingController@updateCustomJS')->name('admin-gs-update-custom-js');
...
/*Route::prefix('user')->group(function () {
    ...
    // User Dashboard
    Route::get('/hesabim', 'User\UserController@index')->name('user-dashboard');

    /*
    Route::get('/hesabim', function () {
        return view('theme::pages.user.dashboard');
    });


    Route::get('/siparislerim', function () {
        return view('theme::pages.user.orders');
    })->name('user-orders');
...
Route::prefix('hesabim')->group(function () {

    // User Dashboard
    Route::get('/', 'User\UserController@index')->name('user-dashboard');
    // User Login
    Route::get('/giris', 'User\LoginController@showLoginForm')->name('user.login');
    Route::post('/login', 'User\LoginController@login')->name('user.login.submit');
    // User Login End
    ...
    // User Reset
    Route::get('/sifirla', 'User\UserController@resetform')->name('user-reset');
    Route::post('/reset', 'User\UserController@reset')->name('user-reset-submit');
    // User Reset End

    // User Profile
    Route::get('/profil', 'User\UserController@profile')->name('user-profile');
    Route::post('/profile', 'User\UserController@profileupdate')->name('user-profile-update');
    // User Profile Ends
    ...
    // User Wishlist
    Route::get('/istek-listem', 'User\WishlistController@wishlists')->name('user-wishlists');
    Route::get('/wishlist/add/{id}', 'User\WishlistController@addwish')->name('user-wishlist-add');
    Route::get('/wishlist/remove/{id}', 'User\WishlistController@removewish')->name('user-wishlist-remove');
    // User Wishlist Ends
...
// User Orders
    ...
    //Route::get('/orders', 'User\OrderController@orders')->name('user-orders');
    Route::get('/siparis/takip', 'User\OrderController@ordertrack')->name('user-order-track');
    Route::get('/siparis/takip/{id}', 'User\OrderController@trackload')->name('user-order-track-search');
    Route::get('/siparis/{id}', 'User\OrderController@order')->name('user-order');
    Route::get('/indir/siparis/{slug}/{id}', 'User\OrderController@orderdownload')->name('user-order-download');
    Route::get('yazdir/siparis/yazdir/{id}', 'User\OrderController@orderprint')->name('user-order-print');
    Route::get('/json/trans', 'User\OrderController@trans');
...
// Tickets
    Route::get('admin/tickets', 'User\MessageController@adminmessages')->name('user-message-index');
// Disputes
    Route::get('sorun-bildir', 'User\MessageController@adminDiscordmessages')->name('user-dmessage-index');

    Route::get('sorun-bildir/{uuid}', 'User\MessageController@adminmessage')->name('user-message-show');
    Route::post('sorun-bildir/post', 'User\MessageController@adminpostmessage')->name('user-message-store');
    Route::get('sorun-bildir/{uuid}/sil', 'User\MessageController@adminmessagedelete')->name('user-message-delete1');
    Route::post('sorun-bildir/send/message', 'User\MessageController@adminusercontact')->name('user-send-message');
    Route::get('sorun-bildir/load/{uuid}', 'User\MessageController@messageload')->name('user-message-load');
    Route::get('sorun-bildir/{uuid}/cozuldu', 'User\MessageController@adminmessagesolve')->name('user-message-solve');
// User Admin Send Message Ends
...
// User Favorite Seller
    ...
    Route::get('/favori/saticilar', 'User\UserController@favorites')->name('user-favorites');
    Route::get('/favori/{id1}/{id2}', 'User\UserController@favorite')->name('user-favorite');
    Route::get('/favori/satici/{id}/sil', 'User\UserController@favdelete')->name('user-favorite-delete');

// User Favorite Seller Ends

    // User Logout
    Route::get('/cikis-yap', 'User\LoginController@logout')->name('user-logout');
    // User Logout Ends
...
// ************************************ FRONT SECTION **********************************************
    ...
    Route::get('/sepet/', 'Front\CartController@cart')->name('front.cart');
    ...
    Route::post('/addnumcart', 'Front\CartController@addnumcart');
    Route::post('/addtonumcart', 'Front\CartController@addtonumcart');
    Route::post('/addbyone', 'Front\CartController@addbyone');
    Route::post('/reducebyone', 'Front\CartController@reducebyone');
    ...
    // CHECKOUT SECTION
    Route::get('/checkout/', 'Front\CheckoutController@checkout2')->name('front.checkout');
    Route::get('/checkout2/', 'Front\CheckoutController@checkout')->name('front.checkout2');
    ...
    // IyziPay Routes
    Route::post('/iyzipay-submit', 'Payment\IyzipayController@store')->name('iyzipay-submit');;
    Route::post('/iyzipay-callback', 'Payment\IyzipayController@callback')->name('iyzipay-callback');;

    // Garanti Routes
    Route::post('/garanti-submit', 'Payment\GarantiController@store')->name('garanti-submit');;
    Route::post('/garanti-callback', 'Payment\GarantiController@callback')->name('garanti-callback');;
...
// ************************************ FRONT SECTION ENDS**********************************************
    Route::get('giris', 'User\LoginController@showLoginForm')->name('front.login');
    Route::get('/asdasdasd', 'Front\FrontendController@page')->name('front.page');
    Route::get('magaza/{slug}', 'Front\VendorController@index')->name('front.vendor');
    Route::get('{slug}', 'Front\RedirectController@index');



    Route::fallback(function () {
        return response()->view('theme::errors.404')->setStatusCode(404);  // incase you want to return view
    });
