...
@section('content')
    ...
    <div class="content-area">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ $langg->lang629 }} <a class="add-btn"
                                                                 href="{{ route('vendor-prod-physical-create') }}"><i
        ...
        <form id="parionform" action="{{route('vendor-prod-store')}}" method="POST"
                                            ...
                                            <div class="col-lg-12">
                                                <select id="shipperid" name="shipper_id" required="">
                                                    ...
                                                    @foreach($shippers as $shipper)
                                                        <option
                                                            value="{{ $shipper->id }}">{{ $shipper->shipper }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $("#uploadgallery").change(function () {
            ...
            for (var i = 0; i < total_file; i++) {
                ...
                $('#parionform').append('<input type="hidden" name="galval[]" id="galval' + i +
