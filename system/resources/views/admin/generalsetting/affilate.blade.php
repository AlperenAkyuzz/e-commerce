...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Affiliate Information') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-gs-affilate') }}">{{ __('Affiliate Information') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <form action="{{ route('admin-gs-update') }}" id="parionform" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
