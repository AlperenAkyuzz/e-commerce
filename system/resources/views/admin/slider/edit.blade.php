                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="parionform" action="{{route('admin-sl-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="subtitle_anime">{{ __('Animation') }} *</label>
                                                          <select class="form-control" id="subtitle_anime" name="subtitle_anime">
                                                                <option value="Fade" {{$data->subtitle_anime == 'Fade' ? 'selected' :''}}>Fade</option>
                                                                <option value="Fade Cross" {{$data->subtitle_anime == 'Fade Cross' ? 'selected' :''}}>Fade Cross</option>
                                                                <option value="Fade Through Black" {{$data->subtitle_anime == 'Fade Through Black' ? 'selected' :''}}>Fade Through Black</option>
                                                                <option value="Fade Through Light" {{$data->subtitle_anime == 'Fade Through Light' ? 'selected' :''}}>Fade Through Light</option>
                                                                <option value="Fade Through Transparent" {{$data->subtitle_anime == 'Fade Through Transparent' ? 'selected' :''}}>Fade Through Transparent</option>
                                                                <option value="Slide To Top" {{$data->subtitle_anime == 'Slide To Top' ? 'selected' :''}}>Slide To Top</option>
                                                                <option value="Slide To Bottom" {{$data->subtitle_anime == 'Slide To Bottom' ? 'selected' :''}}>Slide To Bottom</option>
                                                                <option value="Slide To Right" {{$data->subtitle_anime == 'Slide To Right' ? 'selected' :''}}>Slide To Right</option>
                                                                <option value="Slide To Left" {{$data->subtitle_anime == 'Slide To Left' ? 'selected' :''}}>Slide To Left</option>
                                                                <option value="Slide Horizontal (Next/Previous)" {{$data->subtitle_anime == 'Slide Horizontal (Next/Previous)' ? 'selected' :''}}>Slide Horizontal (Next/Previous)</option>
                                                                <option value="Slide Vertical (Next/Previous)" {{$data->subtitle_anime == 'Slide Vertical (Next/Previous)' ? 'selected' :''}}>Slide Vertical (Next/Previous)</option>
                                                                <option value="Zoom Out" {{$data->subtitle_anime == 'Zoom Out' ? 'selected' :''}}>Zoom Out</option>
                                                                <option value="Zoom In" {{$data->subtitle_anime == 'Zoom In' ? 'selected' :''}}>Zoom In</option>
                                                          </select>
                                                    </div>
                                                   </div>
