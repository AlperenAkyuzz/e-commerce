...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Import CSV Product") }} <a class="add-btn" href="{{ route('admin-prod-physical-create') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
											<ul class="links">
												<li>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="parionform" action="{{route('admin-import-csv-store')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
