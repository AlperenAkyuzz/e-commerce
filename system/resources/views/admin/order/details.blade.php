                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">@if($order->method == 'Cash On Delivery') {{ __('Cash On Delivery') }} @else {{ $order->method }} @endif</td>
                                                </tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                    ...
                                                    @else
                                                        ...
                                                        <span class="badge badge-warning">{{ __('Pending') }}</span> {{-- ucwords($user->status) --}}
                                                        @elseif($user->status == 'processing')
                                                        <span class="badge badge-info">{{ __('Processing') }}</span>
                                                       @elseif($user->status == 'on delivery')
                                                        <span class="badge badge-primary">{{ __('On Delivery') }}</span>
