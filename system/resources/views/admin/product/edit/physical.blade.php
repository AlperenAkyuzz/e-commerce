...
@section('content')
    ...
    <div class="content-area">
        ...
        <form id="parionform" action="{{route('admin-prod-update',$data->id)}}" method="POST"
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" name="product_condition_check"
                                                           class="checkclick" id="conditionCheck"
                                                                            ...
                                                                            <div class="col-10">
                                                                                <div class="price-container">
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           placeholder="@if($loop->first) {{ __('You can not set price') }} @else 0.00 ( {{ __('Additional Price') }} ) @endif"
                                                                            ...
                                                                            <div class="col-10">
                                                                                <div class="price-container">
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           placeholder="0.00 ({{ __('Additional Price') }})"
                                                                                           value="{{ !empty($selectedAttrs["$inName"]['prices'][$i]) && $checked == 1 ? $selectedAttrs["$inName"]['prices'][$i] : '' }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Select Cargo Carrier') }}*</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select id="shipperid" name="shipper_id" required="">
                                                    <option value="">{{ __('Select Cargo Carrier') }}</option>
                                                    @foreach($shippers as $shipper)
                                                        <option
                                                            value="{{ $shipper->id }}" {{$data->shipper_id == $shipper->id ? 'selected':''}}>{{ $shipper->shipper }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>

                                        <div class="row" id="weightprod">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Product Desi') }}*</h4>
                                                    <p class="sub-heading">{{ __('(Please do not empty this field)') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="weight" type="text" class="input-field" required=""
                                                       placeholder="{{ __('e.g 5') }}" value="{{ $data->weight }}">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" name="free_shipping" class=""
                                                           id="freeShipping" value="1"
                                                           @if($data->free_shipping == 1) checked @endif>
                                                    <label
                                                        for="freeShipping">{{ __('Free Shipping') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Product Tax Rate') }}*</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select name="tax" required="">
                                                    <option value="1" {{$data->tax == '1' ? 'selected':''}}>%1</option>
                                                    <option value="8" {{$data->tax == '8' ? 'selected':''}}>%8</option>
                                                    <option value="18" {{$data->tax == '18' ? 'selected':''}}>%18
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
