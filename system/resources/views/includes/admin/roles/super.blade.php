<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-custom-js') }}"><span>{{ __('Custom JS & CSS') }}</span></a>
            </li>
    ...
    <li>
    <a href="#cargo-management" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-truck"></i>{{ __('Cargo Management') }}
    </a>
    <ul class="collapse list-unstyled" id="cargo-management" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-shippers-index') }}"><span>{{ __('Shippers') }}</span></a>
        </li>

        <li>
            <a href="{{ route('admin-shipping-rates-index') }}"><span>{{ __('Shipping Rates') }}</span></a>
        </li>

        <li>
            <a href="{{ route('admin-shipper-rates-index') }}"><span>{{ __('Shipper Rates') }}</span></a>
        </li>
