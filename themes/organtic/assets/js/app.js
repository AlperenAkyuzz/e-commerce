...
jQuery(document).ready(function() {
    ...
    jQuery("#nav li.level0.drop-menu").mouseover(function() {
        ...
        jQuery("#featured-products .slider-items").owlCarousel({
            items: 4,
            itemsDesktop: [1024, 4],
            itemsDesktopSmall: [900, 3],
            itemsTablet: [600, 2],
...
// <!-- Hot Deals Timer 1--> 
var dthen1 = new Date("12/25/2021 11:59:00 PM");
